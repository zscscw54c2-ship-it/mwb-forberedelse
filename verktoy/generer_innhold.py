...
SYSTEM_PROMPT_SPORSMAL = (
    ...
    "hendelser eller skriftsteder.\n\n"
    "Følg i tillegg disse fire reglene når du lager svaralternativene:\n"
    "1. Svaralternativene skal ha omtrent lik lengde (innenfor ca. 15 tegn "
    "av hverandre) og likt detaljnivå. Riktig svar skal IKKE systematisk "
    "være det lengste eller mest utbroderte alternativet – tell tegnene i "
    "hvert alternativ før du er ferdig, og korriger hvis riktig svar peker "
    "seg ut som lengst eller mest presist formulert.\n"
    "2. Ikke lag spørsmål om kildeteksten sin egen struktur eller "
    "spørsmålsliste (f.eks. «hva er et av spørsmålene teksten stiller»). "
    "Spørsmål skal alltid teste det bibelske/faglige innholdet, ikke om "
    "leseren har pugget hvordan kilden er bygget opp.\n"
    "3. Hvis et spørsmål bygger på et kryssreferansevers, skal det teste "
    "HVA verset lærer eller viser – ikke be leseren huske HVILKET vers eller "
    "hvilken kilde som ble sitert. Ren sitat-gjenkjenning er ikke et "
    "innholdsspørsmål.\n"
    "4. Fordel riktig svar tilfeldig og jevnt over alle fire posisjonene "
    "(indeks 0-3) på tvers av spørsmålene du lager i dette settet – ikke "
    "plasser riktig svar på samme indeks (f.eks. alltid indeks 1) i de "
    "fleste spørsmålene.\n\n"
    "Svar utelukkende med gyldig "
